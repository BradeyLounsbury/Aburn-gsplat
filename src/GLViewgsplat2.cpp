...
{
   GLViewgsplat2* glv = new GLViewgsplat2( args );
...
GLViewgsplat2::GLViewgsplat2( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewgsplat2::New() for
   ...
   //GLViewgsplat2::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewgsplat2::onCreate()
{
   //GLViewgsplat2::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewgsplat2::~GLViewgsplat2()
{
   //Implicitly calls GLView::~GLView()
}


void GLViewgsplat2::updateWorld()
{
...
void GLViewgsplat2::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewgsplat2::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewgsplat2::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewgsplat2::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewgsplat2::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void GLViewgsplat2::onKeyUp( const SDL_KeyboardEvent& key )
{
   GLView::onKeyUp( key );
}
...
void GLViewgsplat2::creategsplat2WayPoints()
{
